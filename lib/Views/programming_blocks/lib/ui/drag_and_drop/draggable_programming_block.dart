...
import 'package:progaming/Views/programming_blocks/lib/ui/drag_and_drop/drag_target.dart'
    as dt;
...
class _BodyDraggableProgrammingBlock extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    ValueNotifier<Offset> feedbackNotifier =
        ValueNotifier(Offset.fromDirection(1.2));
    return Listener(
